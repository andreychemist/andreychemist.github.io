...
Вы можете подать форму I-907 (запрос на ускоренное рассмотрение) с петицией I-140 по категории EB-1A, а с 19 октября 2020 года и по категории EB2-NIW <https://www.uscis.gov/forms/how-do-i-use-premium-processing-service>. (Дополнение от августа 2021 года: мне написали, что хоть закон об ускоренном рассмотрении в случае EB2-NIW принят, USCIS так и не создало процедуру для этого. Поэтому проверяйте сами, доступна такая возможность или нет).
